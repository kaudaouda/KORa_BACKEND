...
class SuivisAPSerializer(serializers.ModelSerializer):
    ...
    def get_media_livrables(self, obj):
        ...
        try:
            ...
            logger.warning("Erreur lors de la récupération des MediaLivrable pour suivi %s: %s", obj.uuid, e)
            return []
    ...
    def get_media_livrables_count(self, obj):
        ...
        try:
            ...
            logger.warning("Erreur lors du comptage des MediaLivrable pour suivi %s: %s", obj.uuid, e)
            return 0
