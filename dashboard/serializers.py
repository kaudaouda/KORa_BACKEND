...
class TableauBordSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        try:
            ...
            logger.error("Erreur lors de la création de l'instance TableauBord: %s", str(e), exc_info=True)
            raise
        ...
        if initial_ref_uuid:
            ...
            if isinstance(initial_ref_uuid, str):
                try:
                    ...
                    logger.error("Erreur lors de la définition de initial_ref: %s", str(e), exc_info=True)
            else:
