    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['app_name', 'code', 'is_active'], name='permission__app_nam_b2881a_idx'), models.Index(fields=['app_name', 'category'], name='permission__app_nam_5bf9d7_idx')],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('processus', models.ForeignKey(help_text='Processus concerné', on_delete=django.db.models.deletion.CASCADE, related_name='app_permissions', to='parametre.processus')),
                ('user', models.ForeignKey(help_text='Utilisateur concerné', on_delete=django.db.models.deletion.CASCADE, related_name='app_permissions', to=settings.AUTH_USER_MODEL)),
                ('permission_action', models.ForeignKey(help_text='Action de permission concernée', on_delete=django.db.models.deletion.CASCADE, related_name='app_permissions', to='permissions.permissionaction')),
            ],
            options={
                ...
                'indexes': [models.Index(fields=['user', 'processus', 'app_name', 'is_active'], name='app_permiss_user_id_bd25c7_idx'), models.Index(fields=['user', 'app_name', 'is_active'], name='app_permiss_user_id_3ff905_idx'), models.Index(fields=['app_name', 'is_active'], name='app_permiss_app_nam_bb3cff_idx'), models.Index(fields=['last_calculated_at'], name='app_permiss_last_ca_094992_idx')],
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['-timestamp'],
                'indexes': [models.Index(fields=['user', 'app_name', 'timestamp'], name='permission__user_id_494bba_idx'), models.Index(fields=['app_name', 'action', 'granted'], name='permission__app_nam_6d50e7_idx'), models.Index(fields=['entity_type', 'entity_id', 'timestamp'], name='permission__entity__5a1180_idx'), models.Index(fields=['timestamp'], name='permission__timesta_25abff_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'ordering': ['user', 'app_name', 'processus', 'permission_action'],
                'indexes': [models.Index(fields=['user', 'processus', 'app_name', 'is_active'], name='permission__user_id_f3a61a_idx'), models.Index(fields=['cree_par', 'created_at'], name='permission__cree_pa_827671_idx')],
                'unique_together': {('user', 'processus', 'app_name', 'permission_action')},
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['role', 'granted', 'is_active'], name='role_permis_role_id_74448e_idx'), models.Index(fields=['permission_action', 'granted'], name='role_permis_permiss_764c3d_idx')],
