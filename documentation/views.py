        ...
        if serializer.is_valid():
            ...
            if fichier:
                try:
                    ...
                    logger.error("Erreur lors de la création du média pour le document %s: %s", document.uuid, media_error)
        ...
        if serializer.is_valid():
            ...
            if fichier:
                try:
                    ...
                    logger.error("Erreur lors de la création du média: %s", media_error)
